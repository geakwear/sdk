...
import com.igeak.android.wearable.DataApi.DataItemResult;
...
import com.igeak.android.wearable.MessageApi.SendMessageResult;
...
public class MainActivity extends Activity implements DataApi.DataListener,
    ...
    private GeakApiClient geakApiClient;
    ...
    protected void onStop() {
        if (!mResolvingError) {
            Wearable.DataApi.removeListener(geakApiClient, this);
            Wearable.MessageApi.removeListener(geakApiClient, this);
            Wearable.NodeApi.removeListener(geakApiClient, this);
            geakApiClient.disconnect();
        }
        super.onStop();
    }
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        Wearable.DataApi.addListener(geakApiClient, this);
        Wearable.MessageApi.addListener(geakApiClient, this);
        Wearable.NodeApi.addListener(geakApiClient, this);
    }
    ...
    private Collection<String> getNodes() {
        ...
        NodeApi.GetConnectedNodesResult nodes =
                Wearable.NodeApi.getConnectedNodes(geakApiClient).await();
    ...
    private void sendStartActivityMessage(String node) {
        Wearable.MessageApi.sendMessage(
                geakApiClient, node, START_ACTIVITY_PATH, new byte[0]).setResultCallback(
    ...
    private class DataItemGenerator implements Runnable {
        ...
        public void run() {
            ...
            Wearable.DataApi.putDataItem(geakApiClient, request)
    ...
    public void onSendPhotoClick(View view) {
        if (null != mImageBitmap && geakApiClient.isConnected()) {
